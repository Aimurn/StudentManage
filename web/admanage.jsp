...
<div class="rightinfo">
  ...
  <div class="tip" style="height: 400px">
    <form method="post" action="adminServlet?tag=add">
      <div class="tiptop"><span>添加管理员</span><a></a></div>
      <div class="tipinfo" style="height: 200px;">
        <div style="margin: 20px 0;">
          <label for="adduser" style="font-size: 16px;">用户名：</label>
          <input type="text" name="adduser" id="adduser" class="layui-input" style="width: 350px;">
        </div>
        <div style="margin: 20px 0;">
          <label for="addpwd" style="font-size: 16px;">密 码：</label>
          <input type="password" name="addpwd" id="addpwd" class="layui-input" style="width: 350px;">
        </div>
        <div style="margin: 20px 0;">
          <label style="font-size: 16px;">管理员类型：</label>
          <input type="radio" name="addtype" value="1"><i style="font-size: 14px; font-style: normal;"> 超级管理员
        </i>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="radio" name="addtype" value="0"><i style="font-size: 14px; font-style: normal;"> 普通管理员
        </i>
        </div>
      </div>
